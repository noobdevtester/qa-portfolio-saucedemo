...
**Expected Result:**  
Error message is displayed indicating that username is required & login is blocked.  
...
**Expected Result:**  
System displays an error message stating that the username & password do not match any user.  
...
**Expected Result:**  
Error message is displayed indicating that the user has been locked out.  
...
**Expected Result:**  
User is redirected to the login page & the item is not added to the cart.  
...
**Expected Result:**  
Item is added only once & the cart icon badge displays the correct number of items.  
...
**Precondition:** User is authenticated and on checkout page with at least one item in cart  

**Steps:**  
1. Navigate to checkout page  
2. Leave First Name field empty  
3. Fill out other required fields correctly  
4. Attempt to proceed with checkout  

**Expected Result:**  
Error message is displayed indicating that the First Name field is required and checkout is blocked.  
