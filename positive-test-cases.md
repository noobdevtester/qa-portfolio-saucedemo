...
**Expected Result:**  
User is successfully redirected to product listing page and email is received for confirmation of sign-up.  
...
**Expected Result:**  
User is successfully redirected to account details and order history.  
...
**Expected Result:**  
The selected item is added to the cart, and the cart icon badge displays the correct number of items.  
...
**Expected Result:**  
User is redirected to the checkout overview page displaying correct item and total details.  
